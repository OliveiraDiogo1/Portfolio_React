                            ...
                            <div className="w-full flex flex-col gap-3 sm:gap-4">
                                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                                    <div className="flex-1">
                                        ...
                                        <input
                                            ...
                                            className={`w-full rounded-xl px-3 sm:px-4 py-2 sm:py-3 bg-zinc-800/50 text-white border-2 outline-none backdrop-blur-sm transition-all duration-300 text-sm sm:text-base ${focusedField === "name" || form.name
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <input
                                            ...
                                            className={`w-full rounded-xl px-3 sm:px-4 py-2 sm:py-3 bg-zinc-800/50 text-white border-2 outline-none backdrop-blur-sm transition-all duration-300 text-sm sm:text-base ${focusedField === "email" || form.email
                                                ? "border-yellow-300 ring-2 ring-yellow-200/20 shadow-yellow-300/10"
                                                : "border-zinc-700 hover:border-zinc-600"
                                                }`}
                                        />
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className={`w-full rounded-xl px-3 sm:px-4 py-2 sm:py-3 bg-zinc-800/50 text-white border-2 outline-none resize-none backdrop-blur-sm transition-all duration-300 text-sm sm:text-base ${focusedField === "message" || form.message
                                            ? "border-yellow-300 ring-2 ring-yellow-200/20 shadow-yellow-300/10"
                                            : "border-zinc-700 hover:border-zinc-600"
                                            }`}
                                    />
                                ...
                                <button
                                    ...
                                    className="relative mt-2 bg-gradient-to-r from-yellow-300 to-yellow-500 hover:from-yellow-400 hover:to-yellow-600 text-black font-bold py-2 sm:py-3 px-6 sm:px-8 rounded-full shadow-lg transition-all duration-300 text-base sm:text-lg group overflow-hidden"
                                >
